...
<link href="/cmfx/public/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/theme.min.css" rel="stylesheet">
<link href="/cmfx/public/simpleboot/css/simplebootadmin.css" rel="stylesheet">
<link href="/cmfx/public/simpleboot/font-awesome/4.4.0/css/font-awesome.min.css?page=index"  rel="stylesheet" type="text/css">
<!--[if IE 7]>
	<link rel="stylesheet" href="/cmfx/public/simpleboot/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
<![endif]-->
<link rel="stylesheet" href="/cmfx/public/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<link href="/cmfx/public/js/artDialog/skins/default.css" rel="stylesheet" />
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/cmfx/public/simpleboot/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
...
<?php foreach($submenus as $menu){ ?>
					<li>
						...
						<?php if(empty($menu['items'])){ ?>
							<a href="javascript:openapp('<?php echo ($menu["url"]); ?>','<?php echo ($menu_name); ?>',true);">
...
<body style="min-width:900px;" screen_capture_injected="true">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<div class="pull-left nav_shortcuts" >
					...
					<a class="btn btn-small btn-warning" href="/cmfx/" title="<?php echo L('WEBSITE_HOME_PAGE');?>" target="_blank">
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							...
							<?php else: ?>
								<img class="nav-user-photo" width="30" height="30" src="/cmfx/admin/themes/simplebootx/Public/assets/images/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>"><?php endif; ?>
	...
	<script src="/cmfx/public/simpleboot/bootstrap/js/bootstrap.min.js"></script>
	<script>
	...
	<script src="/cmfx/public/js/common.js"></script>
	<script src="/cmfx/admin/themes/simplebootx/Public/assets/js/index.js"></script>
</body>
</html>